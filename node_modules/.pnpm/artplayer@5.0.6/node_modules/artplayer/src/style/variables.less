.art-video-player {
    ...
    --art-progress-color: rgba(255, 255, 255, 0.2);
    --art-hover-color: rgba(255, 255, 255, 0.5);
    --art-loaded-color: rgba(255, 255, 255, 0.2);
    --art-loop-color: rgba(255, 255, 255, 0.75);
    --art-state-size: 80px;
    ...
    --art-tip-background: rgba(0, 0, 0, 0.5);

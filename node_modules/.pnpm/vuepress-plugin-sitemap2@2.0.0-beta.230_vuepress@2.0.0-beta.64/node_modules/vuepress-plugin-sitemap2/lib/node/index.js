...
Sitemap: ${l}${f}${u}
`;await $.writeFile(n,o,{flag:"w"}),d.succeed()}},H=(e,t=!0)=>i=>{t&&X(e),N(i,L,"2.0.0-beta.64"),i.env.isDebug&&d.info("Options:",e);const r={name:L};return e.hostname?{...r,onGenerated:l=>_(l,e)}:(d.error(`Option ${S.magenta("hostname")} is required!`),r)};export{H as sitemapPlugin};
